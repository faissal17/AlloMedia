  ...
  console.log(restaurants)
    ...
    <React.Fragment>
      ...
      <table className="divide-gray-200 w-full mt-5">
        ...
        {
          restaurants && restaurants.content.map((restaurant,index)=>(
            <tr >
            <td className="px-6 py-4 whitespace-nowrap">
              <div className="flex items-center">
                <div className="flex-shrink-0 h-10 w-10">
                  <img className="h-10 w-10 rounded-full" src={restaurant.picture} />
                </div>
                <div className="ml-4">
            ...
            <td className="px-6 py-4 whitespace-nowrap  text-sm font-medium">
              ...
              <a href="#" className="ml-2 text-green-600 hover:text-green-900">
